...
public class Groups {
    public static void main(String[] args) {
       ...
       // int[]n = new int[4];
      String [][] groups1 = new String[4][];//this 2d array will hold 4 single dimensial array
        String [][] groups2 = new String[4][3];//this 2d array will hold 4 single dimensial array and each will have 3 elements
