...
public class Store {
    public static void main(String[] args) {
        String store = "Costco";
        int numberOfTv = 100;
        System.out.println("Someone came into the store and they bought TV");
        //numberOfTv = numberOfTv-1
        //ystem.out.println("Someone came into the store and they bought TV");
        System.out.println("Number of TV in stock:" + --numberOfTv);
        System.out.println("Another one bought the same TV");
        System.out.println("Number of TV in stock:" + --numberOfTv);

        System.out.println("Someone else come into the store and out the into the shopping cart but have not paid yet");
        System.out.println("number of tv is in stock(in computer)" + numberOfTv);
